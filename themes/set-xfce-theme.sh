...
BACKGROUND_ORG_PATH="$HOME/.local/share/xomakub-geo/themes/$XOMAKUB_THEME_BACKGROUND"
BACKGROUND_DEST_DIR="$HOME/.local/share/backgrounds"
BACKGROUND_DEST_PATH="$BACKGROUND_DEST_DIR/$(echo $XOMAKUB_THEME_BACKGROUND | tr '/' '-')"
